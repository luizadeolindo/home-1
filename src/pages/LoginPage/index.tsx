          ...
          <div className="loginInputPassword">
            <label>
              ...
              <div className="iconHidePassword">
                <input type={showPassword? "text" : "password"} onChange={(e) => setSenha(e.target.value)} required/>
                <button onClick={hidePassword} type="button"><img src={showPassword ? iconOffHidePassword : iconOnHidePassword} /></button>
              </div>
